...
diary(fullfile(RUNDIR,'rlfit.log')); diary on;
...
T0=tic;
for s=1:NSEG
    t0=tic; out=fullfile(RUNDIR,sprintf('rlfit_seg%d.mat',s));
    fprintf('----- segment %d/%d -----\n', s, NSEG);
    try
