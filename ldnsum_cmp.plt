...
;----------------
pltcol=1 : select= : ydata=$5 : zdata=$12
include qolr_tone/ldnsumbw.txt
plot
;----------------
pltcol=2 : select= : ydata=$5 : zdata=$12
include qolr_flat/ldnsumbw.txt
plot
;----------------
pltcol=4 : select= : ydata=$5 : zdata=$12
include qolr_lono/ldnsumbw.txt
plot
;----------------
pltcol=12 : select= : ydata=$5 : zdata=$12
